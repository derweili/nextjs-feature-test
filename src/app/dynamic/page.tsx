...
async function DynamicContent() {
  // Get request headers first (required for Cache Components - access data before Date.now())
  const headersList = await headers();
  
  // Generate different content on every render (after accessing headers)
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-6">
            <Suspense fallback={
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                <p className="text-sm text-blue-700 dark:text-blue-300">Loading dynamic content...</p>
              </div>
            }>
              <DynamicContent />
            </Suspense>
