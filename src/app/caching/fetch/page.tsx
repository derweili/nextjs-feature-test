      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Demonstrates different fetch caching strategies in Next.js, including force-cache, no-store, and time-based revalidation. The timestamps shown are fetched from an external mock API, not generated by Next.js itself. Compare how each strategy affects data freshness and caching behavior.
          </p>
